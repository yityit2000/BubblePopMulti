...
namespace BubblePop
{
    class Constants
    {
        ...
        public static float WORLD_HEIGHT = 960f;
        ...
        //public static float WORLD_HEIGHT = (GRID_HEIGHT_IN_UNITS + 2) * WORLD_UNIT;

        public static Vector2 BUBBLE_GRID_ORIGIN = new Vector2(WORLD_UNIT / 2, WORLD_HEIGHT - (WORLD_UNIT * (1 + GRID_HEIGHT_IN_UNITS)));
        public static float BOTTOM_OF_GRID = WORLD_HEIGHT - 2 * WORLD_UNIT;
